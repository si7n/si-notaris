    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Sistem Informasi Pelaporan Akta Notaris</strong>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['Tanggal_Akta'] ?></td>
                                    <td><?= $data['Jenis_Akta'] ?></td>
                                    <td><?= $data['Penghadap'] ?></td>
                                    <td><?= $data['Saksi_Saksi'] ?></td>
